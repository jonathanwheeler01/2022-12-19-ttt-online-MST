...
humandate: "Dec 19-20, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm MST"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2022-12-19      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2022-12-20        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Jon Wheeler", "Eric Jankowski","Karen Colbert"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: [""]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
contact: ["jwheel01@unm.edu", "kbarnes@carpentres.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
